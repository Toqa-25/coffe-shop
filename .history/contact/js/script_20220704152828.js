...
if (contactFormUserName.value.trim() != "" && contactFormEmail.value.trim() != "" && contactFormText.value.trim() != "" && contactFormPhone.value.trim() != ""){
console.log        signUpFormConfirmPassword.value = ""
