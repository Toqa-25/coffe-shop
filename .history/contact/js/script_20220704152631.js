...
signUpFormConfirmPhone = document.getElementById("re-password");
...
// if (contactFormUserName.value.trim() != "" && contactFormEmail.value.trim() != "" && contactFormUserName.value.trim() != ""){
