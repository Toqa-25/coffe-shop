...
//  addProductToUserCart(productRemoveCartButtons)
 saveFavorite(productAddFavoriteButtons)
 unSaveFavorite(productDeleteFavoriteButtons)
 
}
// adding products to user cart
// function addProductToUserCart(productRemoveCartButtons){
//     productRemoveCartButtons.map(productRemoveCartButtons => {
//         productRemoveCartButtons.onclick = function (e){
//             if (! logInUserName){ 
