    ...
    productAddToCartButtons.map(productAddToCartButton => {
        productAddToCartButton.onclick = function (e){
            ...
            let currenElement = e.currentTarget,
                parentOfCurrentElement = currenElement.parentE,
...
productsArray.map(productsArrayItem => {
    productsArrayItem.onclick = function (e){
        ...
        let currentElement = e.currentTarget,
            ...
            users[indexOfUser].favoritArray ? users[indexOfUser].favoritArray = [...favoritArray , products[productIndex] ] : users[indexOfUser].favoritArray = [ products[productIndex] ]
            drowProducts(products)
...
productsArray.map(productsArrayItem => {
    productsArrayItem.onclick = function (e){
        let currentElement = e.currentTarget,
            ...
            // currentElement.classList.remove("fav")
            // currentElement.classList.add("heart-item")
