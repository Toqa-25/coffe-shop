...
productsArray.map(productsArrayItem => {
    productsArrayItem.onclick = function (e){
        ...
        let currentElement = e.currentTarget,
            ...
            // currentElement.classList.contains("fav") ? products[productIndex].like="like" :  products[productIndex].like ? delete products[productIndex].like : console.log ("non")
