...
export {manue , logInUserName , users , indexOfUser , drowProducts}
/************ vars data *************/ 
...
export function drowProducts( array) {
    manue.innerHTML= "";
...
export function addProductToUserCart(productAddToCartButtons){
...
export function checkUsersExisitProducts ( index ){
...
// /*******************/
export function unSaveFavorite(productsArray) {
    productsArray.map(productsArrayItem => {
        productsArrayItem.onclick = function (e){
            if (! logInUserName){ 
                Swal.fire(`Please signUp or SignIn`)
