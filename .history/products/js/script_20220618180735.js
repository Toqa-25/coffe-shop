    ...
    productAddToCartButtons.map(productAddToCartButton => {
        productAddToCartButton.onclick = function (e){
            ...
            let currenElement = e.currentTarget,
                ...
                users[indexOfUser].userProducts ? checkUsersExisitProducts ( products[productIndex] ) : addNewProducToUserProducts()
...
function checkUsersExisitProducts (  ){
    let userProducts = [...users[indexOfUser].userProducts] ,        product = products[productIndex] 
