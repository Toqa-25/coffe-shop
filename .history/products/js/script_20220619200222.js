...
function like(){
    ...
    let drow =  function (){ 
    for (let i=0 ; i<= 9 ; i++){
  return `  <div class="manue-product" id ="${products[i].prodId}" data-index="${products[i].prodId-1}">
  <img src="images/products/${products[i].prodImg}" alt="" class="manue-product-img">
  <h3 class="manue-product-name capitalize">${products[i].prodName}</h3>
  <p class="manue-product-price">${products[i].prodPrice} <span class="before-price">${products[i].beforeProdPrice}</span></p>
  <button class="btn manue-product-btn">add to cart </button>
...
<img src="images/products/${products[i].prodImg}" alt="" class="manue-product-img">
<h3 class="manue-product-name capitalize">${products[i].prodName}</h3>
<p class="manue-product-price">${products[i].prodPrice}
 <span class="before-price">${products[i].beforeProdPrice}</span>
</p>
<button class="btn manue-product-btn">add to cart </button>
 <div class=" heart-item">
<i class=" ${products[i].like ? "fas" : "far"} fa-heart" ></i>
</div>
</div>
`
    })
}
console.log (drowNeadedProducts(productsArray))