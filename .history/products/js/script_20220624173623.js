...
let logInUserName = localStorage.getItem("logInUserName") ,
 ...
 indexOfUser =  JSON.parse(localStorage.getItem("newUsers")) ,
...
function setUserIndex (){
    if (logInUserName){
       ...
       if ( userItem.name == logInUserName){
           indexOfUser = index;
     localStorge.setItem("indexOfUser" , indexOfUser)
       }
       })  
   } 
}
...
//   } )]
                   // productsData[index] = favoritArrayItem
                //    console.log (favoritArrayItem)
                //    return favoritArrayItem
