...
productsArray.map(productsArrayItem => {
    productsArrayItem.onclick = function (e){
        ...
        let currentElement = e.currentTarget,
            ...
            users[indexOfUser].favoritArray ? users[indexOfUser].favoritArray = [...favoritArray , products[productIndex] ] ?users[indexOfUser].favoritArray = [...favoritArray , products[productIndex] ]
            drowProducts(products)
