    ...
    productAddToCartButtons.map(productAddToCartButton => {
        productAddToCartButton.onclick = function (e){
            ...
            let currenElement = e.currentTarget,
                ...
                users[indexOfUser].userProducts ? checkUsersExisitProducts (users[indexOfUser].userProducts , products[productIndex] ) :  users[indexOfUser].userProducts = [products[productIndex]]
