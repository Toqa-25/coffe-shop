    ...
    productAddToCartButtons.map(productAddToCartButton => {
        productAddToCartButton.onclick = function (e){
            ...
            let currenElement = e.currentTarget,
                ...
                users[indexOfUser].userProducts ?  users[indexOfUser].userProducts = [...users[indexOfUser].userProducts ,products[productIndex] ] :  users[index].userProducts = [products[productIndex]]
                // userProducts = users[index].userProducts
