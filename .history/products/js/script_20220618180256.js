    ...
    productAddToCartButtons.map(productAddToCartButton => {
        productAddToCartButton.onclick = function (e){
            ...
            let currenElement = e.currentTarget,
                ...
                users[indexOfUser].userProducts ? checkUsersExisitProducts ([...users[indexOfUser].userProducts] , products[productIndex] ) : addNewProducToUserProducts()
...
function checkUsersExisitProducts ( product ){
    let userProducts = [...users[indexOfUser].userProducts]
    let exisiteProduct =    userProducts.find ((product)  =>  userProduct == product )
