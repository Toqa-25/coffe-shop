...
if (userIcon){
    userIcon.addEventListener("click" , finalToggleActiveClass)
...
logInUserName = localStorage.getItem("logInUserName"),
    indexOfUser =  localStorage.getItem("indexOfUser") ,userProducts ;
  ...
  function checkLogInUser(){
            if (localStorage.getItem("logInUserName")){
              ...
              logOut()
                ...
                userIconOptions.innerHTML = ""
                userIconOptions.innerHTML = `<li class="sign-in-btn user-option-item capitalize"><a href="sign-in/index.html" class="link-none capitalize   text-color">sign in</a></li>
                                            <li class="sign-up-btn user-option-item capitalize">sign up</li>`;
            }
        }
        checkLogInUser()
