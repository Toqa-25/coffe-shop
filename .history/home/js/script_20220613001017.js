...
signInBtn = document.querySelector(".user-options .sign-in"),
...
// userIconOptions.onclick = function (){
//     console.log("lorem")
// }
signUpBtn.onclick = function 
// if (userIconOptions.classList.contains("show-user-icon-options")){

//     signInBtn.onclick = function (){
//         console.log("sign in lorem")
//     }
// }
