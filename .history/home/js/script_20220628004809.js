...
export {body , loadinSection , lightButtonCircle , lightButton , barIcon  , userIcon , userIconOptions , logOutBtn ,
    signInBtn , signUpBtn ,  navListItem , shoppingIcon , shoppingIconItems , searchIcon  , searchIconContent , navListIcons , navListIconsArray , numOfProducts }
...
let users =  JSON.parse(localStorage.getItem("newUsers")) ,
    ...
    userProducts  = users[indexOfUser].userProducts , numOfProducts = 0 ;
    ...
    localStorage.setItem("newUsers" , localStorage.getItem("newUsers"))
