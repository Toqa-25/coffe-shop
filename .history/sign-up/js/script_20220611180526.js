...
signUpFormUserName.onchange = checkExisitData(signUpFormUserName , useName , "signUpFormUserName" , "userName" )
...
//        }
//     }
function checkExisitData(input , ObjneadedValue , localStorgeItemName , itemNameMsg ){
    if (input.value != ""){
       newUsers.map(newUserItem => {
